...
% ****** Make sure working directory is in data folder with T = 0.9 to run code ******
...
energy_data = {'d_0.1_T_0.9_energies.txt','d_0.2_T_0.9_energies.txt','d_0.3_T_0.9_energies.txt',...
    'd_0.4_T_0.9_energies.txt','d_0.5_T_0.9_energies.txt','d_0.6_T_0.9_energies.txt'};
...
csvwrite('T_09_coords.txt',compiled_coords)
csvwrite('T_09_energies.txt',compiled_energies)